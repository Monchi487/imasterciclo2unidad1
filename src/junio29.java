 ...
 */
/*
 * int numero = 5; do{ System.out.println(":)"); numero--; //numero = numero -1
 * }while(numero>8);
 */
/*
 * String valor = ""; do{ Scanner scanner = new Scanner(System.in); valor =
 * scanner.nextLine (); }while(valor.equals("");)
 */
